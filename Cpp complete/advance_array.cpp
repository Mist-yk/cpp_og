...
// 1 -Find the candidate using the Boyer-Moore Voting Algorithm in the first loop.
// 2 -Verify the candidate by counting its occurrences in the second loop.
// 3 -If the candidate appears more than half the times, it is the majority element; otherwise, return -1.
// class Solution {
// public:
